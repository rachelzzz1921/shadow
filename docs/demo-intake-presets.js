  ...
  const PRESETS = [
    {
      ...
      blurb: '直接入学，211 宿舍第一夜',
      layerA: {
        choice_text: '如果当年我没有选择复读，而是直接去上了那所211',
        self_description: '我习惯用成绩证明自己，但那个夏天，我第一次试着接受一个够好但不完美的答案，然后继续走。',
        one_liner: '我以为放手是认输，后来才知道，那是另一种出发。',
        birth_year: 2005,
        fork_year: 2023,
        age_at_fork: 18,
        gender: 'female'
