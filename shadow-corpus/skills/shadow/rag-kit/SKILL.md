...
| 顺序 | 文件 | 何时 |
|------|------|------|
| 1 | [`docs/plans/2026-06-14-rag-engineering-plan.md`](../../../docs/plans/2026-06-14-rag-engineering-plan.md) | 分期、暂停/恢复决策 |
| 2 | [`02-technical-design/05-rag-system.md`](../../../02-technical-design/05-rag-system.md) | 全链路方案 |
| 3 | [`packages/rag-kit/README.md`](../../../packages/rag-kit/README.md) | 命令与三模式 |
| 4 | [`packages/rag-kit/INTEGRATION.md`](../../../packages/rag-kit/INTEGRATION.md) | demo 接入缝 |
| 5 | [`reference.md`](reference.md) | 文件地图、env、验收 |
| 6 | [`examples.md`](examples.md) | 常见命令 |
