...
<!-- TASK-AUTO:START -->
> **自动生成** `2026-06-14 05:43` · 源 [registry.json](./tasks/registry.json) · 可读版 [TASK-LIBRARY.md](./tasks/TASK-LIBRARY.md) · 刷新 `npm run board`
...
#### CHG-002 — 第二条 Golden：Wave 5 可选 backlog

| 状态 | ID | 任务 | 波次 | 阶段 | 负责 | 执行 | 依赖 | 产物 |
|------|-----|------|------|------|------|------|------|------|
| ⬜ | ◇ [T-025](#task-t-025) | 第二条 golden 大纲 | W5 | backlog | P2 | 👤 | T-022 | — |

#### CHG-003 — 多 Run 对比：Wave 5 可选 backlog
...
- 🟡 [T-001](./team-roster.md) **Kickoff：五人角色与本周目标**（P1 · 产品 / PM） → [产物](./team-roster.md)
...
|------|------|------|--------|--------|--------|-----|
| **P1** | 产品 / PM | 6 | 1 | 3 | 1 | `mine P1` |
| **P2** | 叙事 / 内容 | 12 | 0 | 4 | 3 | `mine P2` |
| **P3** | 工程 Lead | 10 | 0 | 3 | 0 | `mine P3` |
| **P4** | QA / 评测 | 6 | 0 | 2 | 2 | `mine P4` |
| **P5** | 工具 / 集成 | 4 | 0 | 2 | 1 | `mine P5` |
