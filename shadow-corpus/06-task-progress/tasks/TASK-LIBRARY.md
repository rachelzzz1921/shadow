...
| ID | 名称 | 说明 | 进度 |
|----|------|------|------|
| [INFRA-001](../changes/INFRA-001-team-onboarding/progress.md) | 团队 Onboarding | Kickoff、花名册、Agent 分工、共读 golden | 3/4 |
| [CHG-000](../changes/CHG-000-corpus-reorg/progress.md) | Corpus 整合 | 唯一入口确认、gap 扫描、skills 基线 | 3/4 |
| [CHG-001](../changes/CHG-001-p0-migration/progress.md) | P0 三项迁移 | memory 检索 · reflection · intervention re-plan | 11/16 |
| [CHG-V001](../changes/CHG-V001-visual-fuxduxian/progress.md) | Visual 复读线 | 叙事 v2 · 像素素材 · Phaser · 7 年 layout | 7/8 |
| CHG-H001 | Harness Wave 4 closed loop | 静态 demo v2 · smoke · eval visual · 文档对齐 | 12/12 |
| CHG-002 | 第二条 Golden | Wave 5 可选 backlog | 1/1 |
| CHG-003 | 多 Run 对比 | Wave 5 可选 backlog | 1/1 |
...
| ✅ | [H-001](../docs/demo-data.js) | 静态 demo 挂 v2 visual 字段 | W4 | 03 编码 | P3 | 🤖CX | — | [demo-data.js](../docs/demo-data.js) |
| ✅ | [H-002](../archive/demo-v0.2/test/harness-smoke.test.js) | Live harness smoke 测试 | W4 | 04 自测 | P3 | 🤖CX | ~~H-001~~ | [harness-smoke.test.js](../archive/demo-v0.2/test/harness-smoke.test.js) |
| ✅ | [H-003](../archive/demo-v0.2/lib/evaluator.js) | Evaluator visual 一致性 warn | W4 | 04 自测 | P3 | 🤖CX | — | [evaluator.js](../archive/demo-v0.2/lib/evaluator.js) |
| ✅ | [H-004](../02-technical-design/01-shadow-harness-loop.md) | Harness loop 文档路径对齐 | W4 | 06 进度 | P5 | 🤖CX | — | [01-shadow-harness-loop.md](../02-technical-design/01-shadow-harness-loop.md) |
| ✅ | [H-005](../tooling/scripts/harness-live-smoke.mjs) | harness:smoke CLI 脚本 | W4 | 04 自测 | P3 | 🤖CX | ~~H-002~~ | [harness-live-smoke.mjs](../tooling/scripts/harness-live-smoke.mjs) |
| ✅ | [H-006](../archive/demo-v0.2/lib/dialogue-hook.js) | Dialogue hook 契约 + 测试 | W4 | 04 自测 | P3 | 🤖CX | ~~H-002~~ | [dialogue-hook.js](../archive/demo-v0.2/lib/dialogue-hook.js) |
| ✅ | [H-007](../docs/demo-phaser.html) | Phaser layout 预览页（docs/demo-phaser） | W4 | 03 编码 | P3 | 🤖CX | ~~H-001~~ | [demo-phaser.html](../docs/demo-phaser.html) |
| ✅ | [H-008](../tooling/scripts/harness-live-smoke.mjs) | harness:smoke:full 七年 mock | W4 | 04 自测 | P3 | 🤖CX | ~~H-005~~ | [harness-live-smoke.mjs](../tooling/scripts/harness-live-smoke.mjs) |
| ✅ | [H-009](../archive/demo-v0.2/lib/fate-hook.js) | Fate hook 契约 + /api/fate/context | W4 | 04 自测 | P3 | 🤖CX | ~~H-006~~ | [fate-hook.js](../archive/demo-v0.2/lib/fate-hook.js) |
| ✅ | [H-010](../archive/demo-v0.2/public/visual-preview.html) | archive visual-preview + index 入口 | W4 | 03 编码 | P3 | 🤖CX | ~~H-007~~ | [visual-preview.html](../archive/demo-v0.2/public/visual-preview.html) |
| ✅ | [H-011](../archive/demo-v0.2/server.js) | Dialogue API placeholder fallback（无 key） | W4 | 03 编码 | P3 | 🤖CX | ~~H-006~~ | [server.js](../archive/demo-v0.2/server.js) |
| ✅ | [H-012](../archive/demo-v0.2/public/index.html) | Live index fate overlay + era-snippets fallback | W4 | 03 编码 | P3 | 🤖CX | ~~H-009~~, ~~H-010~~ | [index.html](../archive/demo-v0.2/public/index.html) |
...
- **Wave 4** — 自测 · QA · 发布签字
- **Wave 5** — 可选增强 backlog
- **Wave 4h** — Harness 持续迭代（Wave 4 loop）
